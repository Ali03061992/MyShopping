...
class ProductCategoryResourceIT {
    ...
    public static ProductCategory createEntity(EntityManager em) {
        ProductCategory productCategory = new ProductCategory().categoryName(DEFAULT_CATEGORY_NAME);
    ...
    public static ProductCategory createUpdatedEntity(EntityManager em) {
        ProductCategory productCategory = new ProductCategory().categoryName(UPDATED_CATEGORY_NAME);
        return productCategory;
    }
    ...
    void putExistingProductCategory() throws Exception {
        ...
        updatedProductCategory.categoryName(UPDATED_CATEGORY_NAME);
