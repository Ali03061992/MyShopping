...
import com.tn.shopping.config.EmbeddedKafka;
...
@WithMockUser
@EmbeddedKafka
class MyShoppingKafkaResourceIT {
    ...
    void producesMessages() throws InterruptedException {
        client.post().uri("/api/my-shopping-kafka/publish?message=value-produce").exchange().expectStatus().isNoContent();
    ...
    void consumesMessages() {
        ...
        String value = client
            .get()
            .uri("/api/my-shopping-kafka/consume")
