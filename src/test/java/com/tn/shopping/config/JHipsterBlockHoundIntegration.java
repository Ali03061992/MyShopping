package com.tn.shopping.config;
...
public class JHipsterBlockHoundIntegration implements BlockHoundIntegration {
    ...
    public void applyTo(BlockHound.Builder builder) {
        ...
        builder.allowBlockingCallsInside("com.tn.shopping.service.MailService", "sendEmailFromTemplate");
        builder.allowBlockingCallsInside("com.tn.shopping.security.DomainUserDetailsService", "createSpringSecurityUser");
