...
type ProductFormDefaults = Pick<NewProduct, 'id' | 'productCategories'>;
...
type ProductFormGroupContent = {
  ...
  productCategories: FormControl<IProduct['productCategories']>;
};
...
export class ProductFormService {
  createProductFormGroup(product: ProductFormGroupInput = { id: null }): ProductFormGroup {
    ...
    return new FormGroup<ProductFormGroupContent>({
      ...
      productCategories: new FormControl(productRawValue.productCategories ?? []),
    });
  }
